...
Site and page parameter names, layout file names, partial template file names, scratch names and other runtime keys and strings, CSS names, and JavaScript names beginning with "paige" capitalized in any way are reserved.
