...
<dl>
    ...
    <dd>Optional. String. Type of layout. Grid and rows layouts use the horizontal axis as the main axis, and the vertical axis as the cross axis. Must be <code>grid</code> or <code>rows</code>. Default is <code>rows</code>.</dd>
    <dt><code>width</code></dt>
...
- [bootstrap](https://www.npmjs.com/package/bootstrap/v/5.3.0-alpha3)
